...
type
   ...
   TdwsUnitTestsContext = class
      ...
      public
         ...
         function  FuncFastEval(const args : TExprBaseList) : Variant;
         function  FuncFastPointEval(const args : TExprBaseList) : Variant;
...
// FuncFastEval
//
function TdwsUnitTestsContext.FuncFastEval(const args : TExprBaseList) : Variant;
begin
...
// FuncFastPointEval
//
function TdwsUnitTestsContext.FuncFastPointEval(const args : TExprBaseList) : Variant;
var
   rec : TData;
begin
   SetLength(rec, 2);
