...
var b1 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [5]);
var b2 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [5]);
var b3 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [5]);
