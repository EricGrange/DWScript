...
var b1_1 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [3]);
var b1_2 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [3]);
var out1 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [3]);
b1_1.SetData([0], 1); b1_1.SetData([1], 2); b1_1.SetData([2], 3);
b1_2.SetData([0], 10); b1_2.SetData([1], 20); b1_2.SetData([2], 30);

TKCLKernelCompiler.Dispatch(k, [b1_1, b1_2, out1]);

// Dispatch 2: 2D array of 2x2 elements (Statelessness test)
var b2_1 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [2, 2]);
var b2_2 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [2, 2]);
var out2 := TKCLStridedBuffer.Create(TKCLDataType.Float32, [2, 2]);
...
TKCLKernelCompiler.Dispatch(k, [b2_1, b2_2, out2]);
