...
var a2 : array of Float := [2, 3, 4, 5, 6];
PrintLn('Multiply: ' + Sum(a1.Multiply(a2)).ToString);

var a3 : array of Float := [1, 1, 1, 1, 1];
var a4 : array of Float := [10, 20, 30, 40, 50];
PrintLn('Multiply Offset: ' + Sum(a3.Multiply(a4, 1, 2, 2)).ToString);
