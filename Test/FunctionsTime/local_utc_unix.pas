...
PrintLn(UnixTimeToLocalDateTime(c17_12_2018_UnixTime) - (EncodeDate(2018, 12, 17) + 2/24) );
PrintLn(UnixTimeToLocalDateTime(c14_08_2018_UnixTime) - (EncodeDate(2018, 8, 14) + 4/24) );
