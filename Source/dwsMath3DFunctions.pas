...
// DoEval
//
procedure TVectorScaleLeftOpExpr.DoEval(args : TExprBaseList; var result : IDataContext);
var
   f : Double;
   vec : PVarDataArray;
begin
...
// DoEval
//
procedure TVectorScaleRightOpExpr.DoEval(args : TExprBaseList; var result : IDataContext);
var
   f : Double;
   vec : PVarDataArray;
begin
