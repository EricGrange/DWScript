...
// DoEvalAsVariant
//
function TOleInt16Func.DoEvalAsVariant(const args : TExprBaseList) : Variant;
begin
...
// DoEvalAsVariant
//
function TOleInt32Func.DoEvalAsVariant(const args : TExprBaseList) : Variant;
begin
...
// DoEvalAsVariant
//
function TOleInt64Func.DoEvalAsVariant(const args : TExprBaseList) : Variant;
begin
...
// DoEvalAsVariant
//
function TOleCurrencyFunc.DoEvalAsVariant(const args : TExprBaseList) : Variant;
begin
...
// DoEvalAsVariant
//
function TOleDateFunc.DoEvalAsVariant(const args : TExprBaseList) : Variant;
begin
...
// DoEvalAsVariant
//
function TOleSingleFunc.DoEvalAsVariant(const args : TExprBaseList) : Variant;
begin
   VarClear(Result);
...
// DoEvalAsVariant
//
function TOleDoubleFunc.DoEvalAsVariant(const args : TExprBaseList) : Variant;
begin
