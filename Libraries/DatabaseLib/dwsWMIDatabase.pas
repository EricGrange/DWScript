...
type
   ...
   TdwsWMIDataSet = class (TdwsDataSet)
      ...
      public
         procedure Open(const service : IDispatch; const sql : String; const parameters : TData);
...
// Exec
//
procedure TdwsWMIDataBase.Exec(const sql : String; const parameters : TData; context : TExprBase);
begin
...
// Query
//
function TdwsWMIDataBase.Query(const sql : String; const parameters : TData; context : TExprBase) : IdwsDataSet;
var
   ds : TdwsWMIDataSet;
begin
...
// Open
//
procedure TdwsWMIDataSet.Open(const service : IDispatch; const sql : String; const parameters : TData);
const
