object FrmBasic: TFrmBasic
  ...
  object MainMenu: TMainMenu
    ...
    object MnuScript: TMenuItem
      ...
      object MnuScriptCompile: TMenuItem
        Action = AcnBuildDoc
        Caption = 'Build Self Documentation'
      end
    end
  end
  object ActionList: TActionList
    ...
    object AcnBuildDoc: TAction
      Category = 'Script'
      Caption = 'Build Documentation'
      ShortCut = 120
      OnExecute = AcnBuildDocExecute
    end
  end
  ...
  object SynMultiSyn: TSynMultiSyn
    Options.AutoDetectEnabled = False
    Options.AutoDetectLineLimit = 0
    Options.Title = 'Scripted HTML Syntax Highlighter'
    Options.Visible = False
    Schemes = <
      item
        StartExpr = '<?pas='
    ...
    DefaultLanguageName = 'Scripted HTML'
    Left = 200
    Top = 280
  end
